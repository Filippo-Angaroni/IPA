...
ipachars = [ "ɑ", "æ", "ɐ", "ɑ̃", "β", "ɓ", "ʙ", "ç", "ɕ", "ð", "d͡ʒ", "ɖ", "ɗ", "ə", "ɚ", "ɵ", "ɘ", "ɛ", "ɜ", "ɝ", "ɛ̃", "ɞ", "ɠ", "ɢ", "ʛ", "ɡ", "ħ", "ɦ", "ɥ", "ɧ", "ʜ", "ɪ", "ɨ", "ɪ̈", "ʝ", "ɟ", "ʄ", "ɫ", "ɭ", "ɬ", "ʟ", "ɮ", "ɱ", "ŋ", "ɲ", "ɳ", "ɴ", "ɔ", "œ", "ɒ", "ɔ̃", "ɶ", "ø", "ɸ", "ɾ", "ɹ", "ʁ", "ʀ", "ɻ", "ɽ", "ɺ", "ʃ", "ʂ", "θ", "t͡ʃ", "t͡s", "ʈ", "ʊ", "ʉ", "ʌ", "ʋ", "ⱱ", "ɯ", "ʍ", "ɰ", "χ", "ɣ", "ʎ", "ʏ", "ɤ", "ʒ", "ʐ", "ʑ", "ʔ", "ʕ", "ʡ", "ʢ" ]
